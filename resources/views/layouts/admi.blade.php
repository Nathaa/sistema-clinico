...
<head>
  ...
  <meta name="keywords" content="clinica, citas, dientes, doctor, notas, tratamiento">
  <meta name="robots" content="index,follow"/>


  <meta name="og:title" content="Sistema Clinico">
  <meta name="og:description" content="Sistema Clinico, Página principal donde se introduce.....">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{ route('citas.index') }}"><i class="fa fa-link"></i> <span>Link</span></a></li>
