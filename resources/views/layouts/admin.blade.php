...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
               <div class="pull-right">
                  <a href="{{ route('logout') }}"  class="btn btn-success" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Salir</a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019<a href="{{ route('home') }}">DiseñandoSonrisas</a>.</strong>DerechosReservados
